...
The user inputs a name for their project to create a master Google Sheet that includes a summary information on each of the companies search for. Then, they input the exact names (NOT case sensitive) for all the companies they would like to search for separated by ", ". 
...
• a function to generate pie charts
