---
title: "Process Automation - UK Companies House Corporate Data Extraction & Processing"
author: "Sara Hassani"
output: html_document
---
The following code aims to automate the data extraction process from UK Companies House. It is also the basis of an R package created from the functions developed in this code. The package is not yet public.
...
companies = "stamford brayham limited, phenolic limited, gemini maritime limited, perfume idols limited, oneorganic ltd, wrapid packaging ltd, valorem capital one ltd, renaissance 09 ltd, mansion mortgage services limited"
